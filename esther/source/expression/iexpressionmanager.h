...
public:
    ...
    //    virtual Expression *createList(const std::list<Expression *> &nodes) = 0;

    //    virtual Expression *createTuple(const std::list<Expression *> &nodes) = 0;
    ...
    //    virtual Expression *createCall(Expression *self, const std::string &name, const std::list<Expression *> &args) = 0;
    ...
    //    virtual Expression *createFunctionDefinition(Expression *type, Expression *name, const std::list<Expression *> &params, Expression *body, bool variadic, bool dynamic) = 0;
    //    virtual Expression *createMethodDefinition(Expression *type, Expression *name, const std::list<Expression *> &params, Expression *body, bool variadic, bool dynamic) = 0;
    ...
    //    virtual Expression *createGCCollect() = 0;
    //    virtual Expression *createGCRealloc() = 0;
};
