...
void RootClass::defFunc(const std::string &name, int arity, const std::function<Object *(Object *, const std::vector<Object *> &)> &body) {
    setAttribute(name, esther->createNativeFunction(name, arity, [=](Object *self, const std::vector<Object *> &args) -> Object * {
...
void RootClass::defOper(const std::string &name, Variant (*body)(const Variant &, const Variant &)) {
    setAttribute(name, esther->createNativeFunction(name, 1, [=](Object *self, const std::vector<Object *> &args) -> Object * {
