...
enum { tNone = Token::invalidTokenId,

       tPlus, tMinus, tMultiply, tDivide, tMod,
       tLt, tGt, tLe, tGe, tEq, tNe,
       tAnd, tOr, tXor, tNot,
       tAssign, tPlusAssign, tMinusAssign, tMultiplyAssign, tDivideAssign, tModAssign,
       tDec, tInc,
       ...
       tTrue, tFalse, tNull, tSelf, tSuper, tContext,
       tContinue, tBreak, tReturn, tInclude,
       tClass, tStatic, tMethod, tFunction,
       tTry, tThrow, tCatch,

       tId, tInteger, tFloat, tString, tComplexString,
       tUnknown, tEnd };
