...
Expression *ExpressionManager::createContextResolution(Expression *self, Expression *body, bool object) {
    return new ContextResolutionExpression(self, body, object);
}
