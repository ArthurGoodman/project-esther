...
void CharacterClass::setupMethods(Esther *esther) {
    ...
    defFunc(esther, "isSpace", [=](Esther *, Pointer<Object> self, const std::vector<Pointer<Object>> &) -> Pointer<Object> {
        return esther->toBoolean(Utility::isSpace(((ValueObject *)*self)->getVariant().toChar()));
    });

    defFunc(esther, "isDigit", [=](Esther *, Pointer<Object> self, const std::vector<Pointer<Object>> &) -> Pointer<Object> {
        return esther->toBoolean(Utility::isDigit(((ValueObject *)*self)->getVariant().toChar()));
    });

    defFunc(esther, "isLetter", [=](Esther *, Pointer<Object> self, const std::vector<Pointer<Object>> &) -> Pointer<Object> {
